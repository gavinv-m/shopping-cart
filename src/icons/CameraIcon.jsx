export default function CameraIcon({
  ...
  return (
    <div className="camera-icon-container">
      ...
      >
        <g>
          <circle fill={color} cx="20" cy="12" r="1" />
          <path
            fill={color}
          ...
          />
          <circle fill={color} cx="15" cy="17" r="1" />
          <circle fill={color} cx="10" cy="12" r="1" />
          <circle fill={color} cx="15" cy="7" r="1" />
          <circle fill={color} cx="37" cy="17" r="1" />
          <circle fill={color} cx="37" cy="7" r="1" />
          <circle fill={color} cx="32" cy="12" r="1" />
          <circle fill={color} cx="42" cy="12" r="1" />
          <rect x="17" y="38" fill={color} width="18" height="10" />
        </g>
      </svg>
    </div>
  );
